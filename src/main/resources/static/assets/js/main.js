...
function scrolltitle() {
  ...
  window.setTimeout("scrolltitle()", 500);
}
scrolltitle();
...
function showTooltip(button) {
  ...
  // Ajusta la posición del tooltip en relación con el documento
  ...
  // Agrega un evento para ocultar el tooltip cuando se haga clic fuera de él
